...
public class FireDolphinEnemy extends Enemy{
    ...
    private final int MAX_SHOOT_FRAME = 2;

    private final int MAX_INVINCIBILITY_FRAME = 32;
    private int invincibilityFrame = 0;
    private int hp = 3;

    public FireDolphinEnemy(GameWindow gW, Vector2 worldPos, String spritePath, int element){
        super(gW, worldPos);
    ...
    public void shootPlayer(){
        ...
        Projectile p = new FireDolphinProjectile(getgW(), new Vector2(spawnPoint));
