...
public class DarkDolphinEnemy extends Enemy{
    ...
    public DarkDolphinEnemy(GameWindow gW, Vector2 worldPos, String spritePath, int element){
        super(gW, worldPos);
    ...
    public void shootPlayer(){
        ...
        Projectile p = new DarkDolphinProjectile(getgW(), new Vector2(spawnPoint));
