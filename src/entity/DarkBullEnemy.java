...
public class DarkBullEnemy extends Enemy{
    ...
    public DarkBullEnemy(GameWindow gW, Vector2 worldPos, String spritePath, int element){
        super(gW, worldPos);
        setElement(element);
    ...
    public void process(){
        ...
        if (!isDead() && isActive()){
            setInAttackRange(getWorldPosition().distanceTo(getgW().getPlayer().getWorldPosition()) <= 576);
            // walking state
