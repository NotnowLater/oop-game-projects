...
public class SunFlowerEnemy extends Enemy{
    ...
    public SunFlowerEnemy(GameWindow gW, Vector2 worldPos, String spritePath, int element){
        super(gW, worldPos);
        setElement(element);
    ...
    public void shootPlayer(){
        ...
        Projectile p = new BirdShootingProjectile(getgW(), new Vector2(spawnPos), "sprites/grass_projectile.png", new Rectangle(spawnPos.getX() + 9 * getgW().TILE_SCALE, spawnPos.getY() + 9 * getgW().TILE_SCALE, 6 * getgW().TILE_SCALE, 6 * getgW().TILE_SCALE));
