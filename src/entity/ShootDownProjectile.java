...
public class ShootDownProjectile extends Projectile{

    public ShootDownProjectile(GameWindow gW, Vector2 worldPosition){
        super(gW, worldPosition);
        loadSprites("sprites/enemy_5_projectile.png");
