...
public class DarkDolphinProjectile extends Projectile{

    public DarkDolphinProjectile(GameWindow gW, Vector2 worldPosition){
        super(gW, worldPosition);
        loadSprites("sprites/dark_enemy2_projectile.png");
