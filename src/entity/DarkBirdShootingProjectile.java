...
public class DarkBirdShootingProjectile extends Projectile{

    public DarkBirdShootingProjectile(GameWindow gW, Vector2 worldPosition, String spritePath, Rectangle hitBox){
