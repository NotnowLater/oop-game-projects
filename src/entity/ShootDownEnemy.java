...
public class ShootDownEnemy extends Enemy{
    ...
    public ShootDownEnemy(GameWindow gW, Vector2 worldPos, String spritePath, int element){
        super(gW, worldPos);
    ...
    public void shootPlayer(){
        Projectile p = new ShootDownProjectile(getgW(), new Vector2(getWorldPosition().getX() , getWorldPosition().getY() + 16 * getgW().TILE_SCALE));
