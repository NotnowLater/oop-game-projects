...
//        player.setWorldPosition(new Vector2(18571, 602));
        ...
        enemies.add(enemyFactory.getEnemy(2, new Vector2(9504, 1596)));
        enemies.add(enemyFactory.getEnemy(2, new Vector2(15936, 1164)));
        enemies.add(enemyFactory.getEnemy(2, new Vector2(16848, 684)));
        enemies.add(enemyFactory.getEnemy(2, new Vector2(5952, 1500)));
        enemies.add(enemyFactory.getEnemy(2, new Vector2(3888, 1116)));
        enemies.add(enemyFactory.getEnemy(2, new Vector2(12816, 1308)));
        enemies.add(enemyFactory.getEnemy(2, new Vector2(14448, 972)));
